...
public class Sudoku{
    ...
    public static void main(String[] args) {
        ...
        //}
        fillBoard(board, boardAnswer, list);
    }
    ...
    public static void fillBoard(String [][] board, String [][] boardAnswer, int [] list) {
        Random number = new Random();
        int correctBoard = 0;
        while (correctBoard == 0) {
            for (int i = 0; i < 9; i++) {
                for (int j = 0; j < 100; j++) {
                    list = shuffle(list);
                }
            ...
            print(board);
            correctBoard = checkBoard(board);
        }
        System.out.println(correctBoard);
    }

    public static int checkBoard(String [][] board) {
        int choice = 0;
        //take one number in a column and check its column to see if there are repeats
